...
namespace MyHouseIntegrationTests.Shared
{
    public abstract class BaseIntegrationTest
    {
        ...
        {
            //TODO - can't get valid token yet!! - probably should be possible, just don't know how!
        ...
        {
            //using an undocumented endpoint to turn our admin token into a live user token
            ...
            request.AddBody(
                new
                {
                    //ED - this is the token generated by the firebase admin sdk - need to call the nodejs app here!
